...
//----------分页查询主题信息
$sql = "SELECT username as author_name,pid,hicon,title,rcount,nodename,ctime,coin,retime from tt_user INNER JOIN tt_post ON uid = authorid WHERE tt_post.rid = 0 ORDER BY ctime DESC,retime DESC limit $offset,10";
